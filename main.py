...
Original file is located at
    https://colab.research.google.com/drive/1voyofThc9VkChLeAdiRpe7njn-sIVKHt
...
print("Hello, " + firstname + " " + lastname + ", you are " + str(age))
...
# Print the grade
print("Your score is in range: ", score)
...
if (number2 != 0 and number1 % number2 == 0):
  print(number1, " can be divided by ", number2)
else:
...
if (side1 + side2 > side3 and side2 + side3 > side1 and side1 + side3 > side2):
  print("3 lines can form a triangle")
else:
  print("3 lines can't form a triangle")
...
if operation == "/" and num2 == 0:
  print("Numbers can't be divided as second number equals to 0")
else:
  # Perform the operation
  if operation == "+":
      result = num1 + num2
